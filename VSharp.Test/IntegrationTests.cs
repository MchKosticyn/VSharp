...
public class TestSvmAttribute : NUnitAttribute, IWrapTestMethod, ISimpleTestBuilder
{
    ...
    private class TestSvmCommand : DelegatingTestCommand
    {
        ...
        private class Reporter(UnitTests unitTests) : IReporter
        {
            public void ReportFinished(UnitTest unitTest) => unitTests.GenerateTest(unitTest);
            public void ReportException(UnitTest unitTest) => unitTests.GenerateError(unitTest);
    ...
    private static NUnitTestCaseBuilder _builder = new();
